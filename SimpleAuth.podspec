Pod::Spec.new do |s|
  s.name         = 'SimpleAuth'
  s.version      = '0.3.10'
  s.summary      = 'Simple social authentication for iOS. - userow fors'
  s.homepage     = 'https://github.com/userow/SimpleAuth'
  s.license      = { :type => 'MIT', :file => 'LICENSE' }
  s.author       = { 'Caleb Davenport' => 'calebmdavenport@gmail.com' }
  s.source       = { :git => 'https://github.com/userow/SimpleAuth.git', :tag => "v#{s.version}" }
  s.requires_arc = true
  s.platform     = :ios, '6.0'
