...
#import "SimpleAuthGoogleProvider.h"
...
- (RACSignal *)authorizationCode {
    return [RACSignal createSignal:^RACDisposable *(id<RACSubscriber> subscriber) {
        dispatch_async(dispatch_get_main_queue(), ^{
            SimpleAuthGoogleLoginViewController *login = [[SimpleAuthGoogleLoginViewController alloc] initWithOptions:self.options];
